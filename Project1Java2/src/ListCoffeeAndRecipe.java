...
public class ListCoffeeAndRecipe {
	...
	public void listAll() throws IOException{
		...
		while (scanner.hasNext()) {
			...
			String price_small = data1.next();
			String price_medium = data1.next();
			String price_big = data1.next();

			
			System.out.println(id1+" "+name+"\t"+price_small+"\t"+price_medium+"\t"+price_big+"\t\t"+mash_1+", "+mash_2+", "+mash_3);
		}
